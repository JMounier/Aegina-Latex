...
professionnellement en tant que chef de groupe j'avais la charge d'organiser le travail des différents membres du groupe et de les pousser à travailler pour que le projet avance comme prévu mais cela fut facile car ils étaient tous très motivés et, à part pour l'écriture du \LaTeX{}, je n'ai pas vraiment eu besoin d'agir.

Enfin nous avons fait face à quelques conflits mineurs lors du projet concernant certains aspect du jeu qui avait était mal défini au sein du groupe et dont plusieurs membres avait donc une vision différente. Mais ces conflits se sont très facilement résolus autours d'une discussion et aucune tension n'est vraiment apparu entre les membres du groupe. Je pense que c'est humainement que le projet m'a le moins apporté justement car aucune situation grave n'a eu besoin d'être gérer. Il m'a été facile de m'entendre et de travailler avec les autres membres du groupe d'autant plus que l'un d'eux était mon frère.
