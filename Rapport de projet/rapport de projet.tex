...
\begin{figure}[h!]
\begin{center}\includegraphics[width=14cm]{res/Succes}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{L'environnement graphique et sonore}

\subsection{Interfaces 2D}
...
Trois autres musiques ont par la suite fait leur apparition, chacune d'elles est associée à un thème différent, la forêt, le désert, la neige ou l'automne, qui correspond chacun à un des biomes possibles pour les îles.
...
% partie personalisation du personnage à écrire
...
\begin{figure}[h!]
\begin{center}\includegraphics[width=16cm]{res/Pose}
...
\begin{figure}[h!]
\begin{center}\includegraphics[width=11cm]{res/Inventaire}
...
\end{itemize}
 ...
 \begin{figure}[h!]
\begin{center}\includegraphics[width=14cm]{res/CristalHUD}
...
\paragraph{intéraction avec l'environement}
...
\begin{figure}[h!]
\begin{center}\includegraphics[width=11cm]{res/CristalHUD.png}
...
% réapparition des ressources à écrire
...
% ajouter partie piège

%partie combat à réécrire

\pagebreak

\subsection{système multijoueur}

%intro à faire

\subsubsection{plateforme multijoueur}
...
% encore une intro à faire

\subsection{Phase de test alpha et bêta}
...
% toutes les aprties site web sont à compléter
...
% Table des illustration et Table des matières à faire
