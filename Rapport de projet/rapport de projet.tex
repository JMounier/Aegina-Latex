...
Le projet d'Aegina est finalement terminer. Nous pensons avoir fait un jeu intéressant autant du point de vue d'un joueur que d'un programmeur. Nous avons réaliser tous ce qui était prévu dans le cahier des charges et avons développé de nombreux aspect du jeu bien plus que nous l'imaginions. Finalement ce projet a également été pour nous un moyen d'acquérir de nombreuses compétences qu'elles soient professionnelles ou humaines.
...
Tout d'abord, il fallait que mon travail puisse être lu par tous les membres du groupe. Ce point à été facilement résolu car Florian nous a très vite imposé des normes par rapport à la rédaction de notre code. Et en effet, normaliser tout le code dés le début du projet nous a facilité la communication et la correction des différents scripts.
...
Ce projet m'a appris de nombreuses choses d'un point de vue méthodologique. La méthodologie était mon principal défaut lors du début de ce projet car j'écrivais et je programmais seulement pour que je me comprenne et non pour que l'on me comprenne. Le travaille en groupe, le suivie d'une norme syntaxique lors de la programmation et l'écriture des différents rapport en \LaTeX{} m'ont permis de m'amélioré sur ces points là. 

J'ai également appris à utiliser de nombreux outils informatique comme \og Gimp\fg{}, \og Unity\fg{} ou \og Git\fg{}. J'ai également beaucoup travailler avec le c\# et le \LaTeX{} qui m'on permit de m'amélioré dans ces langages.

professionnellement en tant que chef de groupe j'avais la charge d'organiser les différents membres du groupe et de les pousser à travailler pour que le projet avance comme prévu mais cela fut facile car ils étaient tous très motivé et, à part pour l'écriture du \LaTeX{}, je n'ai pas vraiment eu besoin d'agir.

Enfin nous avons fait face à quelques conflits mineurs lors du projet qui concernait certains aspect du jeu qui avait était mal défini au sein du groupe et dont plusieurs membres avait une vision différentes. Mais ce genre de conflits se sont très facilement résolus autours d'une discussion et aucune tension n'est vraiment apparu entre les membres du groupe. Je pense que ces humainement que le projet m'a le moins apporté justement car aucune situation grave n'a eu besoin d'être gérer. Il m'a été facile de m'entendre et de travailler avec les autres membres du groupe d'autant plus que l'un d'eux était mon frère.
