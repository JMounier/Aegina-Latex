...
Les pingouins d'Aegina sont dotés d'une très grande intelligence, d'un ego surdimensionné et d'une vision assez pessimiste du monde. Cela se remarque dans leur comportement. Les pingouins ignorent royalement les humains ainsi que toutes les autres créatures peuplant Aegina, les jugeant indignes de recevoir une quelconque réaction de leur part. Mais une fois attaqués, ils se résignent extrêmement rapidement, se disant qu'il vont de toute façon finir par mourir un jour et se laissent ainsi dévorer. Leur intelligence leur permet de facilement deviner les intentions des humains et d'éviter leurs pièges.
...
Récemment, nous avons ajouté des fiches d'aide accessibles depuis le menu ou lors de certaines étapes du tutoriel (figure \ref{AideCombat}). Celles-ci donnent une explication plus détaillée de certains systèmes du jeu comme le système de combat par exemple.
...
Le boss final commence chacun de ses combats par un dialogue avec les joueurs expliquant la raison de ses actions. Ce dialogue ne peut pas être passé et les joueurs devront le ré-écouter  à chaque tentative de vaincre le boss. 

Le boss possède 3 attaques. Une attaque horizontale balayant une grande zone devant lui et repoussant fortement les joueurs, une attaque verticale faisant d'énormes dégâts puis infligeant des dégâts à tous les joueurs se trouvant en contact avec le sol. Enfin la troisième attaque crée des cristaux s'écrasant sur les joueurs. Ces cristaux forment un symbole indiquant comment les récupérer. Lors de leur chute ils infligent des dégâts aux joueurs les rencontrant puis une fois dans le sol infligent périodiquement des dégâts à tous les joueurs dans ses alentours.

La seule façon de battre le boss est de récupérer ces cristaux afin de créer un consommable infligeant quelques dégâts au boss si le joueur se trouve près de celui-ci.

Plus les point de vie du boss son faibles plus sa fréquence d'attaque et ses dégâts augmentent. De plus, la quantité de dégâts infligés au boss dépend du nombre de joueurs présents sur la carte.
