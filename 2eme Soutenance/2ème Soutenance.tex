...
\item créer un lieu où nos testeur et nous espérons futur joueurs puissent trouver toutes les informations nécessaire afin de rendre leur expérience en jeu agréable;
...
Sur cette page vous pourrez apercevoir, au premier plan plusieurs éléments : 
\begin{itemize}
...
Sur la pages des actualités, que nous tiendrons à jour un maximum vous pourrez trouver les différents ajouts qu'il y aura dans le jeu.
\\
...
La page wiki est pour notre équipe une page très importante, nous connaissons Aegina et donc nous connaissons la difficulté de rester en vie dans ce monde hostile même pour des personnes aguéris, c'est pourquoi nous avons décidé de mettre en place cette page.
\\
