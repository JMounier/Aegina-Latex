...
Ce rapport rassemble l'ensemble des éléments qui ont été ajouté aux jeu d'Aegina depuis sa création et jusqu'au jour du 16 mars 2016. Il présente les différents éléments du Contexte du jeu d'Aegina et présente chronologiquement les différents ajout fait au jeu en précisant les personnes responsables de ces ajouts. Enfin Il présente les différents éléments qui seront ajouté aux jeu pour la seconde soutenance.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Aegina est un jeu de survie dans lequel le joueur incarne Ille un orphelin au capacité physique hors norme. Le joueur serra amené à découvrir les mystères de l'univers dans lequel il évolue. C'est dans cette partie que nous vous révèlerons ces dits secrets.
...
L'instabilité de ce monde est principalement due à la présence de cristaux sur certaines îles. Ceux-ci sont capables de déchirer les trames de l'espace et du temps permettant de réaliser des miracles comme le retour dans le temps ou la téléportation. La puissance des cristaux est amplifiée lorsqu'ils sont activés. Malgré toutes ces instabilités un écosystème s'est tout de même développé. Des animaux tels que des lapins, papillons et moutons peuplent les îles d'Aegina. Mais d'autres espèces plus agressives et plus exotiques sont apparues suite à l'instabilité du monde. Parmi elles nous trouvons les \textit{slimes}. Un instinct naturel pousse toutes ces créatures agressives à s'attaquer aux cristaux lorsqu'ils sont activés pour les empêcher de rendre le monde plus instable qu'il ne l'est déjà.
 ...
 Certaines autorités humaines utilisent la \og téléportation \fg{} pour se débarrasser d'autres humains. Malheureusement une fois dans le monde d'Aegina ceux-ci tentent désespérément de survivre. Ils finissent en général par arriver à activer les cristaux dont les pouvoirs quasi divins leur permettent d'échapper à la faim et à la mort. Certains ont alors voyagé d'île en île, créant quelques infrastructures telles que des ponts, laissant leur trace dans ce monde mais l'amenant petit à petit à sa fin sans le savoir. Heureusement pour ce monde, jusqu'à présent tous ont fini par périr sous l'assaut des créatures locales ou se sont suicidés en se jetant dans les \textit{abysses} ne pouvant rentrer chez eux. Mais il arrivera bien un jour où l'un d'eux emportera avec lui ce monde dans sa chute. 

\subsection{Ille}

Ille est le personnage que le joueur incarne dans Aegina. De père et de mère inconnue Ille survie depuis son plus jeune âge seul dans une forêt. Malgré le fait de ne pas avoir d'ami, sauf si l'on peux considérer un écureuil comme un ami, Ille est très chaleureux et amical. Cependant Ille n'est pas un enfant sauvage comme son histoire le laisse penser, celui-ci est légèrement civilisé et il a lui même choisi de vivre en autarcie à cause de sa particularité. En effet depuis sa plus jeune enfance Ille possède une force surhumaine (et un certain talent pour la construction), Il a lui même construit sa maison à l'âge de neuf ans et est capable d'abattre des arbres comme un bucheron chevronné depuis qu'il sait manier une hache. Cependant cette force effraie facilement les enfants de son âge et même les adultes mais malgré tous Ille vie de façon paisible. Les repas de Ille ne sont pas très extravagant un jour cela peut être un sanglier et le lendemain un simple champignon, une seule chose concernant sa nourriture elle doit être préparé car Ille tient toujours au fond de lui à ce rapprocher des siens et l'action de préparer la nourriture lui donne l'impression d'être vraiment humain.
      
Son seul défaut si l'on peut  considérer ceci comme un défaut est d'être simplet. C'est d'une certaines façon une chance car c'est ce défaut qui à permis à l'aventure d'Aegina de commencer. 

Lors d'un hiver très rude Ille n'eut pas d'autre choix que de voler de la nourriture dans un village avoisinant mais malheureusement la discrétion n'étant pas son fort il fut surpris en plein méfait et un garde tenta de l'arrêter. Affaibli mentalement par la fin Ille tenta de passer le garde mais il ne contrôla pas sa force et en le bousculant tua le garde qui était déjà extrêmement affaiblie par le frois et la faim. Ille fut alors poursuivi pour meurtre et rapidement arrêter car malgré sa force Ille restait humain. Il fut condamné à la mort et envoyé dans le néant qui n'était autre qu'Aegina. c'est à son réveil que l'histoire commence.

Cependant Ille n'est pas forcement seul dans Aegina. Il pourra rencontrer d'autres personnes car la mort par envoie dans le néant et une pratique assez courante. Dans un sens retrouver des amis dans ce monde dangereux est une bonne chose car dans Aegina le nombre fait en partie votre force.

\subsection{Le cristal}

Comme déjà dis précédemment Les cristaux dans Aegina sont une existence importante car ceux-ci possède d'énormes pouvoir et sont responsables de l'instabilité du monde. Ils sont en apparence indestructible mais il est toutefois possible de les rendre inactifs. Pour s'activer Ils ont besoins d'absorber divers minerai ce qui arrive très rarement naturellement mais peut être facilement réaliser par des êtres conscients.

Le cristal semble réagir avec tout les minerais spécifiques du monde d'Aegina ainsi qu'avec de nombreuses créatures qui, en présence d'un cristal actif, perdent toute raison et tente de désactiver celui-ci.

A part cela peut de choses sont connues sur les cristaux. Leur compositions est totalement inconnue 
et personnes ne sait d'où ils viennent. Ils ne semblent pas exister depuis la création du monde car de part leur forme géométrique et leur pouvoirs ces cristaux sont de tout point de vue une création d'êtres conscients possédant une technologie très avancé. Mais tout cela reste des suppositions et n'est que d'une petite importance pour notre histoire.
\subsection{Les minerais}

De le monde d'Aegina on peut trouver de nombreux minerai qui permettront d'aider le joueur dans son aventure. Certains de ces minerais existe dans notre monde mais Aegina possède aussi des minerais unique. Dans cette partie nous allons vous présenter les minerais exclusifs au monde d'Aegina.

\subsubsection{Mithril}

Le mithril, dans le monde d'Aegina, est un minerai vert clair un peu plus solide que le fer. Assez rare à la surface des îles, on en trouve toujours en petite quantité en sous-sol puisqu'il est l'un des deux minéraux nécessaires à la \og survie \fg{} d'une île. Le mithril a l'étrange particularité de modifier les phénomènes étranges d'Aegina parfois en les amplifiant d'autres fois en les stabilisant. Il est impossible de savoir comment celui-ci va réagir avant de l'utiliser.
...
Ce minerai est encore un mystère d'Aegina car personne ne sait pourquoi il flotte. Il n'est pas plus léger que l'air puisqu'il reste à une distance fixe du sol mais il ne semble pas s'agir non plus de force magnétique. De toute façon peu d'expériences ont eu lieu sur le floatium car, en Aegina, en plus d'être un minerai très rare, les personnes capables de faire des expérimentations scientifiques le sont encore plus.
 ...
 Néanmoins, il est possible de conjecturer que si un cristal à une trop grande influence sur une île, il pourrait provoquer sa chute. Mais les seules personnes connaissant la vérité sont sûrement mortes avec leurs îles.
...
Lors de la création du jeu Il nous est arrivé plusieurs fois de vouloir créer une grande liste d'éléments contenant l'ensemble des \textit{Item} existants, l'ensembles des textes avec leur traduction en anglais ou l'ensemble des éléments pouvant être généré dans le monde. Nous avons donc créé des énumérations contenant tout ces éléments permettant d'accéder à chaque élément facilement. Les texte contenu dans l'énumération des textes ont la particularité de renvoyé le texte correspondant à langue actuelle lorsqu'on l'utilise ainsi tout les textes présents dans le jeu change lors du changement de langue à l'exception des messages informatif du chat.
...
Il a été décider que le joueur ne pourrait interagir avec son environnement que d'une manière très particulière. En effet, la plupart du temps, le joueur utilise un curseur pour sélectionner l'objet avec lequel il veut interagir. Mais ce mécanisme implique un majeur inconvénient : La souris doit être réservée au déplacement du curseur et ce n'est pas envisageable dans notre cas car la souris est utilisée pour le déplacement de la caméra. 

Il a donc fallu trouver une autre méthode pour sélectionner les objets et bien faire comprendre au joueur quel est l'objet actuellement sélectionné. Après concertation, nous avons remarqué que l'objet avec lequel le joueur veut interagir est souvent l'objet le plus proche de lui (\textit{nearElement}). Nous avons donc décidé qu'un joueur ne pourrait interagir qu'avec le \textit{nearElement} et ce en utilisant le click droit. L'avantage de n'interagir qu'avec le \textit{nearElement}  est que celui-ci est unique. Il ne peut y avoir qu'un seul objets le plus proche et si plusieurs object sont a égale distance, alors le premier rencontré serra considéré comme \textit{nearElement}.

Maintenant que la méthode théorique est en place, il faut l'appliquer. Pour ce faire, il suffit de comparer les distances séparant le personnage des objets environnents. La selection du \textit{nearElement} se résume donc a une recherche de minimum. Mais il faut définir l'ensemble de recherche et pour cela, être capable de différencier les objects de l'île par exemple. La solution que nous utilisons est la suivante : Nous imposons un \textit{tag} particulier à tous les objects avec lesquels le joueur peut interagir. \textcolor{red}{ Partie sur le sphère : déso flo mais je me sent pas de l'expliquer. Insister sur la limitation de la recherche grâce à une porter max etc. }.

Le \textit{nearElement} est maintenant sélectionné mais il est impossible pour le joueur de faire la différence entre le \textit{nearElement} et les autres éléments. Pour mettre en valeur le \textit{nearElement}, nous utilisons un \textit{shader} particulier. Les \textit{shaders} indiquent au système de rendue comment un object doit être afficher a l'écran. Le \textit{shader} que nous utilisons ajoute un contour rouge à la silhouette de l'object et assombrie les couleurs de l'object. Il devient donc très facile de distinguer le \textit{nearElement} des autres objects.


\subsubsection{Cristal (Romain et Julien)}

Une particularité du monde d'Aegina et la présence sur certaines de ses îles d'un cristal. Ce cristal n'est pas juste comme les autres éléments du décors tel que les arbres ou les pierres, alors que ceci ont pour but d'être récolter par les joueurs les cristaux eux sont indestructible. Dans la nature les cristaux ont une couleur grise indiquant qu'il n'ont pas été activer par un joueur, ils sont alors inactifs et n'ont aucun effet sur l'environnement qui l'entoure. Lorsqu'un joueur tente d'intéragir avec un cristal inactif une fenêtre (figure~\ref{CristalHUD}) apparait proposant au joueur d'activer le cristal en échange d'un cout en ressource. Cet HUD et en cours de construction et est dimensionné pour contenir les prochains ajouts prévu.
...
La survie étant le thème de notre jeu, il nous fallait construire de bonnes bases pour le développement de cette dernière. Aujourd'hui les éléments clés de notre survie sont présent. Parmi ces éléments, trois sont visible directement en jeu grace à des barres (figure~\ref{LHT}). Deux de ces barres, l'une symbolisant la soif et l'autre la faim de votre personne, se situent en haut à droite de l'écran tandis que la troisième barre, symbolisant la santé, se trouve au dessus de la barre de selection.
...
\end{figure}
 ...
 Lorsque le barre de faim ou de soif est vide, les point de vies de votre personnage commencent à descendre. Cependant ces deux attribut (soif et faim) ne sont pas les seuls à pouvoir s'attaquer à vos points de vie, si vous décidé de sauter dans le vide, votre santé en souffrira également car malgré sa force et sa volonté, Ille ne sait pas voler.
 
 Quand vous vous retrouvez sans points de vie (barre de santé vide) vous sentirez vos force disparaître, c'est ce que nous appelons communément la mort. Cependant, dans notre grande bonté, nous avons décidé que la mort ne serait pas tout de suite définitive et donc chaque mort sera accompagné d'un nouveau début. Pour le moment, le joueur \textit{respawn}, il est téléporté sur la première île qu'il a traversé et ses attributs (santé, soif et faim) sont remis au maximum. La seul façon de mourir réellement dans le jeu est donc de le quitter.
...
Dans cette partie, nous allons vous présenter  les différents concepts que nous implémenterons pour la soutenance \no 2 prévue entre le 2 et le 6 mai 2016. Ces ajouts seront concentré sur le \textit{gameplay} car jusqu'a présent il y a eu de nombreux éléments ajouté au jeux mais aucun de permettant réellement de jouer et de s'amuser.

\subsection{Les quatre grands axes}

Les quatre grands axes sont les sont quatre ajouts qui permettrons d'ajouter de nombreux éléments de \textit{gameplay} à Aegina.

\subsubsection{Création d'objet}

L'ajout de la création d'objet permettra aux joueur d'accéder à une interface de création dans son inventaire lui offrant la possibilité de transformer des objets qu'il possède actuellement en d'autres objets. La liste des objets qu'il pourra créer dépendra de l'avancement du jeu mais aussi de la présence de certains atelier dans les environs (comme une forge par exemple). Cette liste dépendra aussi d'une \textit{connaissance des recettes} ou le joueur devra au préalable créer un objet près d'un atelier spécifique avant de pouvoir créer celui-ci n'importe où dans le monde (ce système est inspirer de \textit{Terraria} et \textit{Don't starve}).

\subsubsection{Ajout des créatures}

L'ajout des créatures sera une part importante de la prochaine version. Elles devront pouvoir se déplacer de manière intelligente et attaquer les joueurs. Certaines des créatures seront passives et par conséquent n'attaqueront pas les joueurs. Les joueurs pourront alors se battre contre ces créatures et récupérer des objets pour progresser dans leur aventure. L'ensemble de ces créatures possèderont une IA passive correspondant à leur déplacement lorsque le joueurs ne se trouve pas dans les environs. Cette IA devra permettre de petit déplacements sur l'île sans rentrer dans les éléments du décor ou tomber dans le vide. Cette IA sera commune à l'ensemble des créatures qu'elles soient passives ou agressives. ces créatures possèderont également une IA correspondant au comportement des créatures lorsque le joueur ce trouve dans les environs mais cette IA la ne sera pas commune à toute les créatures (les créatures agressives attaquerons le joueur tandis que les passives fuirons par exemple).

\subsubsection{Ajout des succès}

Les succès permettrons aux joueurs de suivre l'avancement de l'histoire ainsi que de se remémorer tous les faits héroïques qu'ils ont réalisé. Un joueur pourra consulter ses succès en appuyant sur une touche (à définir) ce qui ouvrira une interface.

 Dans cette fenêtre, les succès serrons hiérarchisés sous la forme d'un arbre. C'est à dire qu'il faudra absolument que le joueur ai réussi un dit succès pour espérer rempoter les succès suivants. Cette structure nous permettra de définir certains événement de l'histoire comme étant des succès et ainsi la bloquer tant que le joueur n'aura pas effectuer une opération clé de l'histoire. Le déclenchement des dialogues de l'histoire seront donc déclenché par la réussite des succès.

\subsubsection{PVP et Conquête}

Cette ajout comporte l'amélioration des cristaux pour que ceux-ci possède un véritable effet sur l'environnement ainsi que l'ajout d'un second mode multi-joueurs où ceux-ci ne jouerons pas en coopération mais les uns contre les autres dans le but de prendre le contrôle des cristaux adverses. ce second mode ce passera dans un monde au dimension limité avec une plus grande présence de cristaux et dans lequel il n'y aura pas d'histoire aussi développé.

L'amélioration des cristaux dans le mode de jeu en coopération permettra de centré les cristaux au centre du \textit{gameplay} car ceux-ci deviendrons essentiel à la survie du joueur. En effet les fonctionnalité de \textit{respawn} dépendrons des cristaux.

\subsection{Les améliorations}

Cette partie contiendra des améliorations des éléments déjà existant ne créant pas forcement du \textit{gameplay}.

\subsubsection{Survie}

La première amélioration de cette partie serra de donner la possibilité au joueur de récolter des ressources grâce au principe d'interaction présenté précédemment. Parmi ces ressources, certaine seront consommable. Ces consommable permettrons au joueur de boire et de manger (plus besoin d'attendre la mort pour retrouver une barre de soif pleine).

Enfin, de nouveaux paramètres tel que la résistance et les dégâts serrons à prendre en compte suite a l'implémentation des créature hostile et du PVP.
...
L'amélioration de l'historie se fera en deux partie : l'écritures des partie de l'histoire qui n'ont pas encore été écrite et l'implémentation d'une partie de l'histoire dans le jeu. Cette ajout contiendra notamment une partie d'histoire essentiel pour tous nouveau joueur lui permettant de découvrir le monde et les différentes interfaces mis à sa disposition : un didacticiel.

\subsubsection{Environnement sonore}

L'ajout de sons / musique nous permettra de dynamiser notre jeu. Différents bruits seront ajoutés aux créatures qui seront de même ajouter à notre jeu, ces bruits rendront ces créature plus impressionnantes ou au contraire attirantes, attention à ne pas ce fier aux apparences ces dernières peuvent être trompeuse...

L'ajout d'une musique qui sera consacrée à la nuit permettra de marquer une différence entre le jour et la nuit dans le monde de Aegina.
