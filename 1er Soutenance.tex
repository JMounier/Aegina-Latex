...
Comme nous l'avions spécifié dans notre cahier des charges, le monde du jeu est généré de manière aléatoire. Pour cette première soutenance, nous avons implémenté la génération d'un \textit{chunk}, et la liaison des chunks entre eux.

Nous avons donc au lancement d'une partie un monde composé de quatre chunks relié par des ponts, chacun de ces chunks est choisi aléatoirement parmis des chunks préfabriqué possédant des îles, des ponts et des ancres. Par la suite un biome est appliqué sur le chunk ce qui influencera le type d'élément qui apparaitra à la place des ancres. Pour finir chaque ancre est donc remplacé par un élément. Si le biome est \textit{désert} par exemple alors une ancre peut être remplacé aléatoirement par un cactus, un rocher, du sable\dots{} ou rien (c'est à dire un élément vide). Cette maniére de générer le monde implique des miliers de mondes possible seulement avec quatre îles.
